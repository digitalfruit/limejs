 ...
 * @inheritDoc
 */
lime.Node.prototype.listen = function(type, handler, opt_capture,
                                      opt_handlerScope) {
 ...
 * @inheritDoc
 */
lime.Node.prototype.unlisten = function(type, handler, opt_capture,
                                        opt_handlerScope) {


  var key = goog.base(this, 'unlisten', type, handler, opt_capture,
      opt_handlerScope);
