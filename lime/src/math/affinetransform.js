...
goog.provide('lime.math.AffineTransform');
 ...
 * @final
 */
lime.math.AffineTransform = function(opt_m00, opt_m10, opt_m01,
 ...
 */
lime.math.AffineTransform.prototype.isIdentity = function() {
...
/**
 * @return {!lime.math.AffineTransform} A copy of this transform.
 */
lime.math.AffineTransform.prototype.clone = function() {
  return new lime.math.AffineTransform(this.m00_, this.m10_, this.m01_,
 ...
 * @return {!lime.math.AffineTransform} This affine transform.
 */
lime.math.AffineTransform.prototype.setTransform = function(m00, m10, m01,
    m11, m02, m12) {
 ...
 *
 * @param {!lime.math.AffineTransform} tx The transform to copy.
 * @return {!lime.math.AffineTransform} This affine transform.
 */
lime.math.AffineTransform.prototype.copyFrom = function(tx) {
  this.m00_ = tx.m00_;
  this.m10_ = tx.m10_;
  this.m01_ = tx.m01_;
  this.m11_ = tx.m11_;
 ...
 * @return {!lime.math.AffineTransform} This affine transform.
 */
lime.math.AffineTransform.prototype.scale = function(sx, sy) {
  this.m00_ *= sx;
  this.m10_ *= sx;
  this.m01_ *= sy;
  this.m11_ *= sy;
 ...
 * @return {!lime.math.AffineTransform} This affine transform.
 */
lime.math.AffineTransform.prototype.preScale = function(sx, sy) {
  this.m00_ *= sx;
  this.m01_ *= sx;
  this.m02_ *= sx;
  this.m10_ *= sy;
 ...
 * @return {!lime.math.AffineTransform} This affine transform.
 */
lime.math.AffineTransform.prototype.translate = function(dx, dy) {
 ...
 * @return {!lime.math.AffineTransform} This affine transform.
 */
lime.math.AffineTransform.prototype.preTranslate = function(dx, dy) {
  this.m02_ += dx;
  this.m12_ += dy;
  return this;
};
 ...
 * @return {!lime.math.AffineTransform} This affine transform.
 */
lime.math.AffineTransform.prototype.rotate = function(theta, x, y) {
  return this.concatenate(
      lime.math.AffineTransform.getRotateInstance(theta, x, y));
};
 ...
 * @return {!lime.math.AffineTransform} This affine transform.
 */
lime.math.AffineTransform.prototype.preRotate = function(theta, x, y) {
 ...
 * @return {!lime.math.AffineTransform} This affine transform.
 */
lime.math.AffineTransform.prototype.shear = function(shx, shy) {
  var m00 = this.m00_;
  var m10 = this.m10_;
 ...
 * @return {!lime.math.AffineTransform} This affine transform.
 */
lime.math.AffineTransform.prototype.preShear = function(shx, shy) {
  var m00 = this.m00_;
  var m01 = this.m01_;
  var m02 = this.m02_;
 ...
 * @override
 */
lime.math.AffineTransform.prototype.toString = function() {
  return 'matrix(' +
 ...
 */
lime.math.AffineTransform.prototype.getScaleX = function() {
  return this.m00_;
};
 ...
 */
lime.math.AffineTransform.prototype.getScaleY = function() {
  return this.m11_;
};
 ...
 */
lime.math.AffineTransform.prototype.getTranslateX = function() {
  return this.m02_;
};
 ...
 */
lime.math.AffineTransform.prototype.getTranslateY = function() {
  return this.m12_;
};
 ...
 */
lime.math.AffineTransform.prototype.getShearX = function() {
  return this.m01_;
};
 ...
 */
lime.math.AffineTransform.prototype.getShearY = function() {
  return this.m10_;
};
 ...
 *
 * @param {!lime.math.AffineTransform} tx The transform to concatenate.
 * @return {!lime.math.AffineTransform} This affine transform.
 */
lime.math.AffineTransform.prototype.concatenate = function(tx) {
  var m0 = this.m00_;
  var m1 = this.m01_;
 ...
 *
 * @param {!lime.math.AffineTransform} tx The transform to preconcatenate.
 * @return {!lime.math.AffineTransform} This affine transform.
 */
lime.math.AffineTransform.prototype.preConcatenate = function(tx) {
  var m0 = this.m00_;
  var m1 = this.m10_;
 ...
 */
lime.math.AffineTransform.prototype.transform = function(src, srcOff, dst,
    dstOff, numPts) {
  var i = srcOff;
  var j = dstOff;
 ...
 */
lime.math.AffineTransform.prototype.getDeterminant = function() {
 ...
 */
lime.math.AffineTransform.prototype.isInvertible = function() {
...
/**
 * @return {!lime.math.AffineTransform} An AffineTransform object
 *     representing the inverse transformation.
 */
lime.math.AffineTransform.prototype.createInverse = function() {
  var det = this.getDeterminant();
  return new lime.math.AffineTransform(
      this.m11_ / det,
      -this.m10_ / det,
      -this.m01_ / det,
      this.m00_ / det,
 ...
 * @param {number} sx The x-axis scaling factor.
 * @param {number} sy The y-axis scaling factor.
 * @return {!lime.math.AffineTransform} A transform representing a scaling
 *     transformation.
 */
lime.math.AffineTransform.getScaleInstance = function(sx, sy) {
  return new lime.math.AffineTransform().setToScale(sx, sy);
};
 ...
 * @param {number} dx The distance to translate in the x direction.
 * @param {number} dy The distance to translate in the y direction.
 * @return {!lime.math.AffineTransform} A transform representing a
 *     translation transformation.
 */
lime.math.AffineTransform.getTranslateInstance = function(dx, dy) {
  return new lime.math.AffineTransform().setToTranslation(dx, dy);
};
 ...
 * @return {!lime.math.AffineTransform} A transform representing a shearing
 *     transformation.
 */
lime.math.AffineTransform.getShearInstance = function(shx, shy) {
  return new lime.math.AffineTransform().setToShear(shx, shy);
};
 ...
 * @param {number} x The x coordinate of the anchor point.
 * @param {number} y The y coordinate of the anchor point.
 * @return {!lime.math.AffineTransform} A transform representing a rotation
 *     transformation.
 */
lime.math.AffineTransform.getRotateInstance = function(theta, x, y) {
  return new lime.math.AffineTransform().setToRotation(theta, x, y);
};
 ...
 * @return {!lime.math.AffineTransform} This affine transform.
 */
lime.math.AffineTransform.prototype.setToScale = function(sx, sy) {
 ...
 * @return {!lime.math.AffineTransform} This affine transform.
 */
lime.math.AffineTransform.prototype.setToTranslation = function(dx, dy) {
 ...
 * @return {!lime.math.AffineTransform} This affine transform.
 */
lime.math.AffineTransform.prototype.setToShear = function(shx, shy) {
 ...
 * @return {!lime.math.AffineTransform} This affine transform.
 */
lime.math.AffineTransform.prototype.setToRotation = function(theta, x, y) {
  var cos = lime.math.TrigTable.getCosineFromRadians(theta);
  var sin = lime.math.TrigTable.getSineFromRadians(theta);
 ...
 *
 * @param {lime.math.AffineTransform} tx The other affine transform.
 * @return {boolean} whether the two transforms are equal.
 */
lime.math.AffineTransform.prototype.equals = function(tx) {
  if (this == tx) {
    return true;
  }
  if (!tx) {
